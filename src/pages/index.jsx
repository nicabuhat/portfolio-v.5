...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Nicaela Cabuhat - Web developer, designer, and aspiring cyclist.
        </title>
        <meta
          name="description"
          content="I’m Nicaela, a front-end web developer and designer based in the Philippines. I’ve been working with individual entrepreneurs and small businesses for over six years where I helped them with their digital presence. "
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Web developer, designer, and aspiring cyclist.
          </h1>
